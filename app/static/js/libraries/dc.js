...
return dc;}
    if(typeof define === "function" && define.amd) {
        define(["d3", "app/static/js/libraries/crossfilter"], _dc);
    } else if(typeof module === "object" && module.exports) {
        var _d3 = require('d3');
        var _crossfilter = require('app/static/js/libraries/crossfilter');
        // When using npm + browserify, 'crossfilter' is a function,
        // since package.json specifies index.js as main_dir function, and it
        // does special handling. When using bower + browserify,
        // there's no main_dir in bower.json (in fact, there's no bower.json),
